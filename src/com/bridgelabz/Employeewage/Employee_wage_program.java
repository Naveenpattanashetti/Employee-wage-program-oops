...
public class Employee_wage_program {
	...
	public  int computeEmpWage(String company, int empRatePerHour, int noOfWorkingDays, int maxHoursPerMonth) {
		int empHrs = 0;
		int totalEmpHrs = 0;
	...
	public  void main(String[] args) {
		...
		employeewage.computeEmpWage("JIO", 40, 21, 120);
		employeewage.computeEmpWage("Wipro", 50, 24, 140);
	}
}